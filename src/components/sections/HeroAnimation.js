...
export default function HeroAnimation() {
    ...
    useEffect(() => {
        const timings = [
            1000, 1000, 1500, 1000, 1800, 2200, 1500, 1500, 4000
        ]
        let timer
        if (step < timings.length - 1) {
            timer = setTimeout(() => setStep((s) => s + 1), timings[step])
        } else {
            timer = setTimeout(() => setStep(0), timings[step])
        }
        ...
        return (
            <AnimContainer animation="animate-rotate-in-ccw">
                <div className="flex flex-col gap-6 max-w-4xl relative z-10">
                    <p className="text-xl sm:text-2xl text-[#4A4458] font-semibold tracking-tight uppercase tracking-widest text-[#6F2DBD]">With the aim to decode</p>
                    <h2 className="text-5xl sm:text-6xl md:text-7xl font-black text-[#171123] leading-tight tracking-tight">Human Digital Behaviour</h2>
                ...
                <div className="w-full max-w-7xl mx-auto px-6 lg:px-16">
                    <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
                        <div className="text-center lg:text-left flex flex-col items-center lg:items-start gap-3">
                            <p className="text-xl sm:text-2xl text-[#6F2DBD] font-semibold tracking-tight">We build Intelligence</p>
                            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-[#171123] leading-tight tracking-tight">Beyond Clicks and Screens</h2>
        ...
        return (
            <AnimContainer animation="animate-zoom-in">
                <div className="flex flex-col gap-6 max-w-5xl items-center">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#171123] leading-tight tracking-tight">A Unified Behaviour Intelligence Layer</h2>
                    <p className="text-xl sm:text-2xl md:text-3xl text-gray-500 font-bold tracking-tight">For Modern Digital Platforms</p>
        ...
        return (
            <AnimContainer animation="animate-zoom-in">
                <div className="flex flex-col items-center justify-center h-full gap-6">
                    <p className="text-xl sm:text-2xl text-[#6F2DBD] font-bold tracking-widest uppercase">Unveiling Cognera</p>
                    ...
                    <p className="text-xl sm:text-2xl text-[#8B8696] font-medium tracking-wide">Measure. Decode. Predict.</p>
                </div>
            </AnimContainer>
        )
    }
                ...
                <div className="w-full max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-12">
                    <div className="flex flex-col items-center md:items-start text-center md:text-left gap-8">
                        ...
                        <div className="overflow-hidden whitespace-nowrap border-r-4 border-[#6F2DBD] animate-typewriter w-0">
                            <p className="text-2xl sm:text-3xl md:text-4xl font-black text-[#6F2DBD] tracking-tight pr-2">Stay • Switch • Return</p>
                        </div>
                        <p className="text-md sm:text-lg text-gray-500 font-bold tracking-widest uppercase max-w-lg">Understanding the true journey of engagement</p>
                        <div className="flex gap-4">
                            <Link href="/contact" className="px-6 py-3 bg-[#171123] text-white font-bold rounded-lg hover:bg-[#6F2DBD] transition-colors shadow-lg">Request Demo</Link>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
                        <div className="text-center lg:text-left flex flex-col items-center lg:items-start gap-4">
                            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-[#171123] leading-tight tracking-tight">
                                ...
                                <span className="text-[#6F2DBD] underline decoration-4 decoration-[#10B981]/30 underline-offset-4 animate-color-cycle">Growth Signals</span>
                            </h2>
            ...
            <AnimContainer animation="animate-fade-in-up">
                <div className="flex flex-col items-center gap-10 w-full max-w-5xl px-4">
                    <div className="text-center space-y-4">
                        <h2 className="text-3xl sm:text-4xl font-bold text-[#171123]">Built on Three Core Principles</h2>
                        <p className="text-lg text-[#4A4458] max-w-2xl mx-auto">Privacy-first behaviour intelligence designed for modern digital platforms.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center gap-3 hover:-translate-y-1 transition-transform duration-300">
                            ...
                            <p className="text-sm text-gray-500 leading-relaxed">Compliance-ready design with minimal data exposure.</p>
                        </div>
                        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center gap-3 hover:-translate-y-1 transition-transform duration-300">
                            ...
                            <p className="text-sm text-gray-500 leading-relaxed">No personal identity tracking, only behavioural patterns.</p>
                        </div>
                        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center gap-3 hover:-translate-y-1 transition-transform duration-300">
                            ...
                            <p className="text-sm text-gray-500 leading-relaxed">Convert attention signals into real growth decisions.</p>
                        </div>
                    </div>
                    <div>
                        <Link href="/contact" className="text-[#6F2DBD] font-semibold hover:text-[#5A2399] flex items-center gap-2 group">
                            Request Demo
    ...
    if (step === 8) {
        return (
            <AnimContainer animation="animate-zoom-in" className="min-h-[500px]">
                <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-16 w-full max-w-6xl px-4">
                    <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left gap-6 animate-slide-in-left" style={{ animationDuration: '0.8s' }}>
                        ...
                        <h1 className="text-5xl sm:text-6xl md:text-7xl font-black text-[#171123] leading-tight tracking-tight">The Behaviour Intelligence Platform</h1>
